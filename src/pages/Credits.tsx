...
import {
  ...
  Phone, MessageSquare, Layers, Mail,
...
const channelUsage = [
  { channel: 'SMS',       icon: Phone,        color: 'text-indigo-600', bg: 'bg-indigo-50', border: 'border-indigo-100',
    msgs: 2840000, rate: '₹0.12', spend: 340800, creditsUsed: 8200 },
  { channel: 'WhatsApp',  icon: MessageSquare, color: 'text-green-600', bg: 'bg-green-50', border: 'border-green-100',
    msgs:  481000, rate: '₹0.48', spend: 231000, creditsUsed: 3100 },
  { channel: 'RCS',       icon: Layers,        color: 'text-red-600',   bg: 'bg-red-50',   border: 'border-red-100',
    msgs:   97000, rate: '₹0.34', spend:  32980, creditsUsed: 1180 },
  { channel: 'Email',     icon: Mail,          color: 'text-sky-600',   bg: 'bg-sky-50',   border: 'border-sky-100',
    msgs:  142000, rate: '₹0.04', spend:   5680, creditsUsed:    0 },
  { channel: 'Voice',     icon: Mic,           color: 'text-violet-600', bg: 'bg-violet-50', border: 'border-violet-100',
